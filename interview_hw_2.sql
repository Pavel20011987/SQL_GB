CREATE DATABASE IF NOT EXISTS Homework_2; -- создание базы данных Homework_2
...
(
    id INT PRIMARY KEY AUTO_INCREMENT,
    employee_id NVARCHAR(45) NOT NULL,
    amount FLOAT,
...
SELECT id, employee_id, amount, -- Перед CASE ставится запятая
CASE
